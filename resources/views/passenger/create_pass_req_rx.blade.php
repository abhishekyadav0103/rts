...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <form class="rts_form" method="POST" action="{{route('passenger_request.save', @$passengerRequest->id)}}" id="pass_req">
                    @csrf
                    ...
                    <div class="form-group row {{ $errors->has('mobile_number') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control mask-phone" placeholder="(___) ___-____" name='mobile_number' id='mobile_number' value="{{old('mobile_number', @$passengerRequest->mobile_number)}}">
                    ...
                    <div class="form-group row {{ $errors->has('alternate_number') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control mask-phone" placeholder="(___) ___-____" name='alternate_number' id='alternate_number' value="{{old('alternate_number', @$passengerRequest->alternate_number)}}">
                    ...
                    <div class="form-group row">
                        <label for="" class="col-sm-4 col-form-label">Prescription account limit covered under lien/LOP before further 
                            authorization is needed</label>
                    </div>
                    <div class="form-group row {{ $errors->has('transportation_limit') ? 'has-error' : '' }}">                        

                        <label for="" class="col-sm-1 col-form-label">$ </label>
                        <div class="col-sm-6">
                            <input id="ex1" class="form-control" type="text" id="transportation_limit" name="transportation_limit" value="500" readonly />
                        </div>
                    </div>
                    <div class="form-group row">                        
                        ...
                        <div class="col-sm-6">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="trans_lm" name="trans_lm" value="1">
                                    ...
                                    <label class="form-check-label" for=""> To edit prescription limit click on checkbox. </label>
                            </div>                            
                             
                            <div class="range_txt">Ruby Rx will require additional case information for limits higher than $500</div>
                    ...
                    <div class="col-lg-7 p-0">
                        <div class="form-group form-check {{ $errors->has('agree') ? 'has-error' : '' }}">
                            <input type="checkbox" class="form-check-input" name='agree' {{old('agree') ? ' checked' : ''}}>
                                ...
                                Ruby Rx <a href="{{url('rxterms')}}">terms and conditions.</a></label>
								@else
									<label class="form-check-label" for="">With my signature below, I, agree to 
...
$(document).ready(function() {
	...
	$('input[name=rx_coverage_yes_no]').on('change', function() {
        //$('.transport_value').text($(this).val());
			//alert($('#rx_coverage_yes_no').val);
			//alert(this.value);
			//alert(document.getElementById("rx_coverage_yes_no").value);
			if(this.value == 1){
				$('#rx_coverage_block').show();
				//document.getElementById("rx_coverage_block").style=block;
			}else{
				$('#rx_coverage_block').hide();
				//document.getElementById("rx_coverage_block").style=none;
			}
    })
