		...
		<div class="row">
            ...
            @endif
				<div class="table-responsive">
				  <form class="rts_form" method="post" action="{{route('rxregister.rxsave')}}" id="Rx">
					@csrf
					...
					<div class="form-group row {{ $errors->has('name') ? 'has-error' : '' }}">
						...
						<div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Law Firm Name" name="name" readonly value="{{old('name',$user->name)}}">
					...
					<div class="form-group row {{ $errors->has('firstname') ? 'has-error' : '' }}">
						...
						<div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="First Name" name="firstname" value="{{old('firstname',$user->firstname)}}" readonly>
					...
					<div class="form-group row {{ $errors->has('lastname') ? 'has-error' : '' }}">
						...
						<div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Last Name" name="lastname" value="{{old('firstname',$user->lastname)}}" readonly>
					...
					<div class="form-group row {{ $errors->has('email') ? 'has-error' : '' }}">
						...
						<div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="example@example.com" name="email" value="{{old('email',$user->statement_email)}}" readonly>
					...
					<div class="form-group row {{ $errors->has('contact_number') ? 'has-error' : '' }}">
						...
						<div class="col-sm-4">
                    <input type="text" class="mask-phone form-control" placeholder="(___) ___-____" name="contact_number" value="{{old('contact_number',$user->contact_number)}}" readonly>
					...
					<div class="form-group row {{ $errors->has('address1') ? 'has-error' : '' }}">
						...
						<div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Street 1" name="address1" value="{{old('address1',$user->street1)}}" readonly>
					...
					<div class="form-group row {{ $errors->has('address2') ? 'has-error' : '' }}">
						...
						<div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="Street 2" name="address2" value="{{old('address2',$user->street2)}}" readonly>
					...
					<div class="form-group row {{ $errors->has('city') ? 'has-error' : '' }}">
						...
						<div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="City" name="city" value="{{old('city',$user->city)}}" readonly>
					...
					<div class="form-group row {{ $errors->has('zip') ? 'has-error' : '' }}">
						...
						<div class="col-sm-4">
                    <input type="text" class="form-control" placeholder="ZIP Code" maxlength="10" name="zip" value="{{old('zip',$user->zip_code)}}" readonly>
					...
					<div class="form-group row {{ $errors->has('notes') ? 'has-error' : '' }}">
						...
						<div class="col-sm-4">
                    <textarea class="form-control" name="notes" readonly>{{old('notes',$user->notes)}}</textarea>
                    {!! $errors->first('zip', '<span class="alert-msg">:message</span>') !!} </div>
            </div>

			<div class="form-group {{ $errors->has('rxagree') ? 'has-error' : '' }}">
				<div class="form-check">
					<label class="form-check-label login_tc">
						<input class="form-check-input" type="checkbox" name="rxagree" {{old('rxagree') ? ' checked' : ''}}>
                    With submission of this form, I agree to Ruby Rx Solutions 
							<a href="{{url('terms')}}">terms and conditions.</a></label>
                                    {!! $errors->first('rxagree', '<br><span class="alert-msg">:message</span>') !!}
				</div>
            </div>
            ...
            <div class="float-right">
                ...
                <button class="btn btn-outline-primary btn_outline_frm" id="saveLawFirm" type="submit">Submit</button>
            </div>
        </form>
        </div>
      </div>
