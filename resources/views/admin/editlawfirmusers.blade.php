      ...
      <div class="col-12">
        <form class="rts_form" method="POST" action="">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" placeholder="Taxman Firm" name="firmname" value="">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-4">
              <select class="form-control">
                ...
                <option value=''>Case Managers</option>
                <option value=''>Call Center Professionals</option>
                <option value=''>Bookkeepers</option>
              </select>
            </div>
          </div>
          <div class="form-group row">
            <label for="" class="col-sm-5 col-form-label">Bar Number <span class="red">*</span></label>
            <div class="col-sm-4">
              <input type="text" class="form-control" placeholder="Bar Number" name="barnumber" value="">
            </div>
          </div>
          <div class="form-group row">
            <label for="" class="col-sm-5 col-form-label">State of License Issuance <span class="red">*</span></label>
            <div class="col-sm-4">
              <select class="form-control">
                <option value=''>Please Select</option>
              </select>
