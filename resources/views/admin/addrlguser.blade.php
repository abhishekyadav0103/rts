      ...
      <div class="col-12">
        <form class="rts_form" method="POST" action="">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" placeholder="example@example.com" name="emailaddress" value="">
            </div>
          </div>
          <div class="form-group row">
            <label for="" class="col-sm-3 col-form-label">Contact Number <span class="red">*</span></label>
            <div class="col-sm-4">
              <input type="text" class="form-control" placeholder="(___) ___-____" name="contactnumber" value="">
            </div>
          </div>
          <div class="form-group row">
